 ...
 * @author santi
 */
public class PopUpStateEditorMenu_New extends JPopupMenu {
    public PopUpStateEditorMenu_New(GameState gs, UnitTypeTable utt, int x, int y, PhysicalGameStatePanel panel) {
