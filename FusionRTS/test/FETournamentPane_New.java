 ...
 * @author santi
 */
public class FETournamentPane_New extends JPanel {
    ...
    public FETournamentPane_New() {
        ...
        
        {
            ...
            
            {
                ...
                for(int i = 0;i<FEStatePane_New.AIs.length;i++) {
                    availableAIsListModel.addElement(FEStatePane_New.AIs[i]);
                }                
                ...
                
        {
...

            {
                ...
                iterationsField = FEStatePane_New.addTextField(p2left,"Iterations:", "10", 4);
                maxGameLengthField = FEStatePane_New.addTextField(p2left,"Max Game Length:", "3000", 4);
                timeBudgetField = FEStatePane_New.addTextField(p2left,"Time Budget:", "100", 5);
                iterationsBudgetField = FEStatePane_New.addTextField(p2left,"Iterations Budget:", "-1", 8);
                preAnalysisTimeField = FEStatePane_New.addTextField(p2left,"pre-Analisys time budget:", "1000", 8);
...

            {
                ...
                
                {
                    ...
                    unitTypeTableBox = new JComboBox(FEStatePane_New.unitTypeTableNames);
        ...
        run.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
                try {
                    ...
                    UnitTypeTable utt = FEStatePane_New.unitTypeTables[unitTypeTableBox.getSelectedIndex()];
