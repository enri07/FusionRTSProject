...
public class FusionRTSWithAWLMAndTR extends FusionRTS {

    public FusionRTSWithAWLMAndTR(UnitTypeTable utt) {
    ...
    public FusionRTSWithAWLMAndTR(int available_time, int max_playouts, int lookahead, int max_depth,
