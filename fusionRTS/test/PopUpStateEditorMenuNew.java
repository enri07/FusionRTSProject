 ...
 * @author santi
 */
public class PopUpStateEditorMenuNew extends JPopupMenu {
    public PopUpStateEditorMenuNew(GameState gs, UnitTypeTable utt, int x, int y, PhysicalGameStatePanel panel) {
