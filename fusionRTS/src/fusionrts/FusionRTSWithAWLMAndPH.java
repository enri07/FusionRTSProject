...
public class FusionRTSWithAWLMAndPH extends FusionRTS {

    public FusionRTSWithAWLMAndPH(UnitTypeTable utt) {
    ...
    public FusionRTSWithAWLMAndPH(int available_time, int max_playouts, int lookahead, int max_depth,
