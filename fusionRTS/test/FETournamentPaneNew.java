 ...
 * @author santi
 */
public class FETournamentPaneNew extends JPanel {
    ...
    public FETournamentPaneNew() {
        ...
        
        {
            ...
            
            {
                ...
                for(int i = 0;i<FEStatePaneNew.AIs.length;i++) {
                    availableAIsListModel.addElement(FEStatePaneNew.AIs[i]);
                }                
                ...
                
        {
...

            {
                ...
                iterationsField = FEStatePaneNew.addTextField(p2left,"Iterations:", "10", 4);
                maxGameLengthField = FEStatePaneNew.addTextField(p2left,"Max Game Length:", "3000", 4);
                timeBudgetField = FEStatePaneNew.addTextField(p2left,"Time Budget:", "100", 5);
                iterationsBudgetField = FEStatePaneNew.addTextField(p2left,"Iterations Budget:", "-1", 8);
                preAnalysisTimeField = FEStatePaneNew.addTextField(p2left,"pre-Analisys time budget:", "1000", 8);
...

            {
                ...
                
                {
                    ...
                    unitTypeTableBox = new JComboBox(FEStatePaneNew.unitTypeTableNames);
        ...
        run.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
                try {
                    ...
                    UnitTypeTable utt = FEStatePaneNew.unitTypeTables[unitTypeTableBox.getSelectedIndex()];
