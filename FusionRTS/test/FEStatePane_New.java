 ...
 * @author santi
 */
public class FEStatePane_New extends JPanel {
    ...
    FEStateMouseListener_New mouseListener;

    public FEStatePane_New() throws Exception {        
...
//                                                System.out.println(gs);
                                    ...
                                    if (trace!=null) {
                                        ...
                                        String traceFileName = FEStatePane_New.nextTraceName();
...
//        p1.add(Box.createVerticalGlue());
        ...
        mouseListener = new FEStateMouseListener_New(statePanel, currentUtt);
