...
public class FEStatePaneNew extends JPanel {
    ...
    FEStateMouseListenerNew mouseListener;

    public FEStatePaneNew() throws Exception {        
...
//                                                System.out.println(gs);
                                    ...
                                    if (trace!=null) {
                                        ...
                                        String traceFileName = FEStatePaneNew.nextTraceName();
...
//        p1.add(Box.createVerticalGlue());
        ...
        mouseListener = new FEStateMouseListenerNew(statePanel, currentUtt);
